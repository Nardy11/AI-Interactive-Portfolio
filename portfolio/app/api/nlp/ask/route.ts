...
const entries: Entry[] = [
  ...
  { section: "experience", position: "testimonials", answer: "My experience includes software development, Flutter internships, freelance FlutterFlow work, and software engineering work. I have worked with ESG& Company, GUC, Egyptian Electrical Solution, Huawei, and other engineering environments.", aliases: ["experience", "work", "internships", "intern", "jobs", "companies"] },
  { section: "experience", position: "testimonials", answer: "At Huawei I worked in Linux and database operations, monitoring, incident and change tickets, logs and operational reporting in a telecom environment.", aliases: ["huawei", "linux", "database administrator", "operations"] },
  { section: "experience", position: "testimonials", answer: "I joined Prime Softworks in a Full-Stack / Software Engineer role associated with Poseidon X, working with modern JavaScript and TypeScript, React/Next.js and backend technologies.", aliases: ["prime softworks", "poseidon x", "software engineer", "full stack engineer"] },
  ...
  { section: "skills", position: "skills", answer: "My main web stack includes React, Next.js, TypeScript, JavaScript, Tailwind CSS and Node.js.", aliases: ["web skills", "web stack", "frontend", "front end", "javascript", "typescript", "technologies", "technology", "tech stack", "tools"] },
