...
const experiences: ExperienceItem[] = [
  ...
  role: "Machine Learning Program",
  place: "Germany (Remote)",
  tags: ["Machine Learning", "NLP", "Data Science", "Python"],
  description: "Completed a machine learning program focused on practical AI and data science. Built a Transaction Category Prediction system using TF-IDF, KMeans and Logistic Regression, processing approximately 540K real-world transactions and achieving ~99% accuracy.",
  logo: "/experience-redi.png",
  logoAlt: "ReDI School of Digital Integration",
},
  {
    date: "Mar 2025",
