      ...
      <section className={styles.heroHome}>
        <div className={styles.container}>
          ...
          <div className={styles.modeCards}>
            <article className={styles.modeCard}><span className={styles.modeNum}>01</span><Image className={styles.modeImage} src="/normal_navigation.png" alt="" width={180} height={90}/><h3>Normal Navigation</h3><p>Explore my portfolio with the traditional interface.</p><ul><li>Projects</li><li>Skills</li><li>Experience</li><li>And more</li></ul><Link href="/projects" className={styles.buttonGhost}>Start Exploring <ArrowRight size={14}/></Link></article>
            <article className={styles.modeCard}><span className={styles.modeNum}>02</span><Image className={styles.modeImage} src="/cv.png" alt="" width={180} height={90}/><h3>Navigate Using<br/>Computer Vision</h3><p>Control your mouse using hand gestures with your camera.</p><ul><li>Hand Tracking</li><li>Virtual Mouse</li><li>Click & Navigate</li></ul><Link href="/cv" className={styles.buttonGhost}>Start Camera Mode <ArrowRight size={14}/></Link></article>
            <article className={styles.modeCard}><span className={styles.modeNum}>03</span><Image className={styles.modeImage} src="/nlp_assistant.png" alt="" width={180} height={90}/><h3>Navigate Using<br/>NLP Assistant</h3><p>Ask questions about my work, skills and experience.</p><ul><li>NLP Assistant</li><li>Semantic Search</li><li>Portfolio Knowledge</li><li>RAG Coming Soon</li></ul><Link href="/nlp" className={styles.buttonGhost}>Start Chat <ArrowRight size={14}/></Link></article>
          </div>
